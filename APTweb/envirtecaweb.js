...
function onload_setup_frames() { 
   update_frame(title_frame, '<html><head><link rel="stylesheet" type="text/css" href="apt.css"/></head><body><body><CENTER><H3>Results : infra_Stress_ISUG_Upgrade_To_LatestLoad.py - 2019.10.02 01:17:56 </CENTER></body></html>');
} 

...
function onload_setup_frames() { 
   update_frame(title_frame, '<html><head><link rel="stylesheet" type="text/css" href="apt.css"/></head><body><body><CENTER><H3>Results : falcon_load_OADM_common_deprovision_Testcase.py - 2019.10.10 15:33:44 </CENTER></body></html>');
} 

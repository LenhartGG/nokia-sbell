// var httpcontent = "http://127.0.0.1:5500/"; //vscode
// var httpcontent = "http://10.243.28.45:5500/"; //vscode
// var httpcontent = "http://10.243.28.45:9991/";  //nginx
var httpcontent = "./"; //vscode

// 原Summary页面地址
// var GlobalLogUrl = "http://aptshanghai.cn.alcatel-lucent.com/~build_load/QFA/SH_TARG_SVT_BUILD_SANITY_4/SH_SVT_SANITY_WEEKLY_BLD1_BATCH/191203103318/logs/test_case_results.html";
// var GlobalLogUrl = "http://linuxdev45.labs.ca.alcatel-lucent.com/~ottsidewinder/QFA/profile/OTT_SVT_DAILY_OFFICIAL_PSS24x_L2_BATCH/191120215358/logs/test_case_results.html";
// var GlobalLogUrl = "http://aptshanghai.cn.alcatel-lucent.com/~build_load/QFA/SH_TARG_SVT_BUILD_SANITY_4/SH_SVT_SANITY_DAILY_BLD1_BATCH/191202115315/logs/test_case_results.html";
...
function getStatusHtml(){
    ...
    function getStatusUrl(){
        ...
        // var field = "/dpeL2_ptp_Fault_By_Debug_Create_Testcase-2";
...
function getFailData(tableData){
    ...
    tbody.children.forEach(function (tr, trIndex){
        tr.children.forEach(function(td){
            var failureClass;
            var failTxt = '';
            if(td.getElementsByClassName('failure')){
                failureClass = td.getElementsByClassName('failure')
                failTxt = $(failureClass[0]).text();
            ...
            if(td.getElementsByClassName('blocked')){
                failureClass = td.getElementsByClassName('blocked')
                failTxt = $(failureClass[0]).text();
